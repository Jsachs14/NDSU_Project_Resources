  /***********************************************************************
 * 
 Written by Joseph Kasti
 Contact @ -> joseph.kasti@gmail.com
 Github: https://github.com/josephkasti
 *
 ***********************************************************************/
...
void loop() {
  ...
  //Serial.println(String("DateTime::TIMESTAMP_DATE:\t")+time.timestamp(DateTime::TIMESTAMP_DATE)); later 
  //Serial.println(String("DateTime::TIMESTAMP_TIME:\t")+time.timestamp(DateTime::TIMESTAMP_TIME)); later
