...
void loop() {
  ...
  if(volt_image<900){
    ...
    if(ohm_helper == ohm_levels[0]){
      totaltracker = (float)(whole_tracker)+(frac_tracker);
    }
    else if(ohm_helper == ohm_levels[1]){
      totaltracker = (float)(whole_tracker * 1000)+(frac_tracker*100);
    }
    else if(ohm_helper == ohm_levels[2]){
      totaltracker = (float)(whole_tracker*1000000)+(frac_tracker*100000);
    }
    else{
      totaltracker = 0;
    }
...
//    Serial.println("Ohms");
    ...
    if(currentMillis-previousMillis>=100){
      ...
      data_points[datacounter%100]=totaltracker;
//      time_points[datacounter%100]=currentMillis;
      datacounter++;
...
//        //TIME POINTS
//        Serial.print("[");
//        Serial.print(time_points[0]);
//        
//        for(int i=1; i<100;i++){
//          Serial.print(",");
//          Serial.print(time_points[i]);       
//        }
//        Serial.println("]");
